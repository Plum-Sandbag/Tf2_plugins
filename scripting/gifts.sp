...
public OnPluginStart()
{
	...
	g_cvarChance = RegisterConVar("sm_gifts_chance", "0.0", "Chance that a gift will be spawned upon player death.", TYPE_FLOAT, INVALID_FUNCTION, 0, true, 0.0, true, 1.0);
	g_cvarLifetime = RegisterConVar("sm_gifts_lifetime", "0.0", "Lifetime of the gift.", TYPE_FLOAT);
