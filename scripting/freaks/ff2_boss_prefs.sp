...
#define FF2BOSSPREFS_VERSION "1.04"
...
public void OnPluginStart()
{
	...
	// ConVars to make
	CreateConVar("ff2_bossprefs_version", FF2BOSSPREFS_VERSION, "Freak Fortress 2: Boss Preferences Version", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY|FCVAR_DONTRECORD);
	...
	FF2QueuePointsCookie = RegClientCookie("ff2_bossprefs_cookies", "FF2 Queue Points Cookies", CookieAccess_Public);		
