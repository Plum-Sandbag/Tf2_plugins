...
Rage_Mokou(index)
{
	...
	SetEntPropEnt(Boss, Prop_Send, "m_hActiveWeapon", SpawnWeapon(Boss, "tf_weapon_flaregun", 351, 100, 5, "2 ; 1.4 ; 99 ; 2.5 ; 209 ; 1 ; 97 ; 0.7 ; 6 ; 0.6 ; 25 ; 0.0"));
		...
		//865:flame_up_speed
		//844:flame_speed
		//839:flame_spread_degree
		//862:flame_lifetime
		//863:flame_random_life_time_offset
...
Fukkatsu_Mokou(index)
{
	new Boss=GetClientOfUserId(FF2_GetBossUserId(index));
	TF2_RemoveWeaponSlot(Boss, TFWeaponSlot_Primary);
	SetEntPropEnt(Boss, Prop_Send, "m_hActiveWeapon", SpawnWeapon(Boss, "tf_weapon_flamethrower", 594, 100, 5, "2 ; 1.4 ; 137 ; 1.5 ; 356 ; 1 ; 128 ; 1 ; 62 ; 0.67 ; 252 ; 0.5 ; 64 ; 0.7 ; 107 ; 1.15 ; 841 ; 0 ; 843 ; 8.5 ; 865 ; 50 ; 844 ; 3000 ; 839 ; 2.8 ; 862 ; 1.3 ; 863 ; 0.1"));
		// 2 - +40% damage done
