...
//						CreateTimer(0.1, Timer_Freeze_HeadCharge, i, TIMER_REPEAT|TIMER_FLAG_NO_MAPCHANGE);
					...
					case 14,201,230,402,526,664,792,801,851,881,890,899,908,957,966,1098,15000,15007,15019,15023,15033,15059,30665://primary
					{
...
//				CreateTimer(0.1, Timer_Freeze_Cloak, i, TIMER_REPEAT|TIMER_FLAG_NO_MAPCHANGE);
	...
	CreateTimer(duration, Timer_EndAbility, bossindex, TIMER_FLAG_NO_MAPCHANGE);
	ISTIMEFREEZED = true;
}

public Action:Timer_TheWorld(Handle:timer, any:client)
{
	RageBoss(GetClientOfUserId(FF2_GetBossUserId(0)));
}
